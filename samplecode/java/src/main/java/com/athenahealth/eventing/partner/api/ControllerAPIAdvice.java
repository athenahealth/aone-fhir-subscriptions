...
public class ControllerAPIAdvice {
    ...
    @ExceptionHandler(SignatureAuthenticationException.class)
    public ResponseEntity<ErrorMessage> validationException(SignatureAuthenticationException ex, WebRequest request) {
        ErrorMessage errorMessage = getErrorMessage(ex);
        return new ResponseEntity<>(errorMessage, HttpStatus.valueOf(HttpStatus.UNAUTHORIZED.value()));

    }

    @ExceptionHandler(MissingRequestHeaderException.class)
    public ResponseEntity<ErrorMessage> validationException(MissingRequestHeaderException ex, WebRequest request) {
